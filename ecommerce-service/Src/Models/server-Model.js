...
class Server{
    ...
    constructor(){
        ...
        this.path={
         ...
         'Vendedor':'/Vendedor',
         'UsuarioInternet':'/UsuarioMercado'
   ...
   async ConectarDb(){
    ...
    Routes(){
        ...
        const {Token,Administrator,Vendedor,UsuarioInternet}=this.path;
        //RUTA PARA EL TOKEN
        ...
        //RUTA PARA LOS USUARIO DE INTERNET
        this.app.use(UsuarioInternet,require('../Routes/usuarioMercado-Route'));
